/**
 * Redacta el HTML de un artículo del blog de Eskala Digital.
 * No genera portadas (se eligen en el admin).
 *
 *   npx tsx scripts/redact-blog-article.ts "https://www.eskaladigital.com/blog/SLUG"
 *   npx tsx scripts/redact-blog-article.ts --slug=mi-slug
