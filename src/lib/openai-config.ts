/**
 * Modelos OpenAI canónicos (mismo criterio que Furgocasa / Alemán / GVC).
 *
 * Texto: gpt-5.6-terra
 * Clasificación rápida: gpt-4o-mini
 *
 * GPT-5.x no acepta temperature custom.
 * Este agente redacta el cuerpo HTML. Las portadas se eligen a mano en el admin
 * (ImagePicker / public/blog): no genera gpt-image-2.
 */
